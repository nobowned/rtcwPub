...
static shader_t *FinishShader( void ) {
	...
	//
	// xhairs are special o.O
	//
	isCrosshairShader = strstr(shader.name, "crosshair") != NULL;
	...
	for ( stage = 0; stage < MAX_SHADER_STAGES; stage++ ) {
		...
		//
		// xhairs need kolors 2 :(
		//
		if (isCrosshairShader) {
...
static void CreateExternalShaders( void ) {
	tr.projectionShadowShader = R_FindShader( "projectionShadowShader", LIGHTMAP_NONE, qtrue );
