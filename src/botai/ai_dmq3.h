...
//pushes bot in front
qboolean BotPush(bot_state_t *bs, int pushclient);
...
//returns nothing, but will reload if needed
void BotCheckReload(bot_state_t *bs, float mult);
//returns true if the entity is dead
qboolean EntityIsDead(aas_entityinfo_t *entinfo);
// returns true if eneity can be gibbed
qboolean EntityIsGibbable(aas_entityinfo_t *entinfo);
// returns true if the head position could be found using tagging.
...
//returns true if their is a revivable teammate nearby
