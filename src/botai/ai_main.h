...
typedef struct bot_state_s
{
	...
	float lastmedic_time;							//time the bot last sent a "Medic!" vtchat
	...
	float revive_time;								//time bot revived someone
	...
	qboolean enemyfar;								//enemy is more than 900 units away
} bot_state_t;
