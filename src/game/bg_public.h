...
// Color bitflags
#define	CF_AUTORELOAD_OFF	(1 << 0)
#define	CF_HITSOUNDS_OFF	(1 << 1)
// NOTE: 3rd least-significant bit isn't being used..
#define	CF_MULTIKILL_OFF	(1 << 3)
#define CF_USE_MP40			(1 << 4)
#define	CF_USE_THOMPSON		(1 << 5)
#define	CF_USE_STEN			(1 << 6)
#define CF_ANTILAG_OFF		(1 << 7)
