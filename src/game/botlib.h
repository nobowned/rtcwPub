...
#define ACTION_ACTIVATE			16384
#define ACTION_SPRINT			32768
...
typedef struct ea_export_s
{
	...
	void	(*EA_Voice)(int client, char *str);
	void	(*EA_VoiceTeam)(int client, char *str);
	void	(*EA_UseItem)(int client, char *it);
	void	(*EA_DropItem)(int client, char *it);
	void	(*EA_UseInv)(int client, char *inv);
	void	(*EA_DropInv)(int client, char *inv);
	void	(*EA_Gesture)(int client);
	void	(*EA_Activate)(int client);
...
typedef struct ai_export_s
{
	...
	int		(*BotChooseRouteGoal)(int goalstate, int team, vec3_t origin, struct bot_goal_s *current_goal, int seconds_doing_route);
	int		(*GetRouteAtIndex)(int index, struct bot_route_s *route);
