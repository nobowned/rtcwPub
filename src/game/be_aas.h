...
#define TFL_DEFAULT	(TFL_WALK|TFL_CROUCH|TFL_BARRIERJUMP|TFL_JUMP|TFL_LADDER|TFL_WALKOFFLEDGE|TFL_SWIM|TFL_WATERJUMP|TFL_TELEPORT|TFL_ELEVATOR|TFL_AIR|TFL_WATER|TFL_SLIME|TFL_JUMPPAD|TFL_FUNCBOB)
