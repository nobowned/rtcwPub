...
void EA_VoiceTeam(int client, char *str) {
	botimport.BotClientCommand(client, va("vsay_team %s", str));
} //end of the function EA_SayTeam
//===========================================================================
//
// Parameter:				-
...
void EA_Voice(int client, char *str) {
	botimport.BotClientCommand(client, va("vsay %s", str));
} //end of the function EA_SayTeam
//===========================================================================
//
// Parameter:				-
...
void EA_Activate(int client) {
	...
	bi->actionflags |= ACTION_ACTIVATE;
} //end of the function EA_Activate
//===========================================================================
//
// Parameter:				-
// Returns:					-
...
void EA_Sprint(int client) {
	...
	bi->actionflags |= ACTION_SPRINT;
} //end of the function EA_Sprint
//===========================================================================
//
// Parameter:			-
// Returns:				-
