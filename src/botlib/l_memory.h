...
//
#ifdef BSPC
#define GetHunkMemory( size )         GetMemoryDebug( size, # size, __FILE__, __LINE__ );
#define GetClearedHunkMemory( size )  GetClearedMemoryDebug( size, # size, __FILE__, __LINE__ );
#else
