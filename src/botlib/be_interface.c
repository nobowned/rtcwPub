...
int Export_BotLibLoadMap( const char *mapname ) {
	...
	BotInitRoutes( mapname );  //be_ai_goal.h
...
static void Init_AI_Export( ai_export_t *ai ) {
	...
	ai->BotChooseRouteGoal = BotChooseRouteGoal;
	ai->GetRouteAtIndex = GetRouteAtIndex;
