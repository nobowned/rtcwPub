...
skill 1
{
	CHARACTERISTIC_NAME							"Bones"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.5
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/bones_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/bones_t.c"
	CHARACTERISTIC_CHAT_NAME					"bones"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/bones_i.c"
